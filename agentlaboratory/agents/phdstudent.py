...
class PhDStudentAgent(BaseAgent):
    ...
    def command_descriptions(self, phase):
        ...
        if phase == "literature review":
            ...
            or phase == "data preparation"
            or phase == "results interpretation"
        ):
            return (
    ...
    def phase_prompt(self, phase):
        ...
        if phase == "literature review":
            ...
            return "You are a PhD student who has submitted their paper to an ML conference called ICLR. Your goal was to write a research paper and get high scores from the reviewers so that it get accepted to the conference.\n"
        return ""
